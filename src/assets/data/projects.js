export const projectsData = [{
        title: "Novice Programmer Struggle Detection, Research Project, Game2Learn Lab",
        details: [
            "Created a feature in iSnap to record student affect to predict moments when students self-assess themselves.  [under review ItiSCE 2023]",
        ]
    },
    {
        title: "Simulating Social Networks, Class Project, Social Computing",
        url: "https://github.ncsu.edu/ssthapi/SimulatingSocialNetworks",
        details: [
            "A python program using Mesa to simulate how agents interact with each other in social networks based on different policies that regulate these communities and how it impacts agents’ emotions and beliefs.",
        ]
    },
    {
        title: "Explicit Testing Strategies,  Independent Study",
        details: [
            "Developed testing strategies for CS 1.5 course, conducted surveys and interviews, then evaluated testing coverage (code, branch, and mutation) to understand student behavior. [under review ItiSCE 2023]",
        ]
    },
    {
